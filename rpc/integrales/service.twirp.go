...
// NewMasterProtobufClient creates a Protobuf client that implements the Master interface.
// It communicates using Protobuf and can be configured with a custom HTTPClient.
func NewMasterProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Master {
		...
		caller = func(ctx context.Context, req *WorkerInfo) (*Acknowledgment, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return c.callRegisterWorker(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
...
func (c *masterProtobufClient) SubmitResult(ctx context.Context, in *IntegralResult) (*Acknowledgment, error) {
	ctx = ctxsetters.WithPackageName(ctx, "github.com.JuanJoseLL.integrales")
	ctx = ctxsetters.WithServiceName(ctx, "Master")
	ctx = ctxsetters.WithMethodName(ctx, "SubmitResult")
	caller := c.callSubmitResult
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *IntegralResult) (*Acknowledgment, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*IntegralResult)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*IntegralResult) when calling interceptor")
					}
					return c.callSubmitResult(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*Acknowledgment)
...
func (c *masterProtobufClient) callSubmitResult(ctx context.Context, in *IntegralResult) (*Acknowledgment, error) {
	out := new(Acknowledgment)
...
// NewMasterJSONClient creates a JSON client that implements the Master interface.
// It communicates using JSON and can be configured with a custom HTTPClient.
func NewMasterJSONClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Master {
	if c, ok := client.(*http.Client); ok {
		client = withoutRedirects(c)
	}
...
func (c *masterJSONClient) SubmitResult(ctx context.Context, in *IntegralResult) (*Acknowledgment, error) {
	ctx = ctxsetters.WithPackageName(ctx, "github.com.JuanJoseLL.integrales")
	ctx = ctxsetters.WithServiceName(ctx, "Master")
	ctx = ctxsetters.WithMethodName(ctx, "SubmitResult")
	caller := c.callSubmitResult
...
// NewMasterServer builds a TwirpServer that can be used as an http.Handler to handle
// HTTP requests that are routed to the right method in the provided svc implementation.
// The opts are twirp.ServerOption modifiers, for example twirp.WithServerHooks(hooks).
func NewMasterServer(svc Master, opts ...interface{}) TwirpServer {
...
func (s *masterServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
	writeError(ctx, resp, err, s.hooks)
}

// handleRequestBodyError is used to handle error when the twirp server cannot read request
func (s *masterServer) handleRequestBodyError(ctx context.Context, resp http.ResponseWriter, msg string, err error) {
...
// MasterPathPrefix is a convenience constant that may identify URL paths.
// Should be used with caution, it only matches routes generated by Twirp Go clients,
// with the default "/twirp" prefix and default CamelCase service and method names.
// More info: https://twitchtv.github.io/twirp/docs/routing.html
const MasterPathPrefix = "/twirp/github.com.JuanJoseLL.integrales.Master/"

func (s *masterServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "github.com.JuanJoseLL.integrales")
	ctx = ctxsetters.WithServiceName(ctx, "Master")
	...
	if pkgService != "github.com.JuanJoseLL.integrales.Master" {
	...
	switch method {
	case "RegisterWorker":
		s.serveRegisterWorker(ctx, resp, req)
		return
	case "SubmitResult":
...
func (s *masterServer) serveRegisterWorker(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	case "application/json":
		s.serveRegisterWorkerJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveRegisterWorkerProtobuf(ctx, resp, req)
	default:
...
func (s *masterServer) serveRegisterWorkerJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "RegisterWorker")
		...
		handler = func(ctx context.Context, req *WorkerInfo) (*Acknowledgment, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.Master.RegisterWorker(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*Acknowledgment)
...
func (s *masterServer) serveRegisterWorkerProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "RegisterWorker")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *masterServer) serveSubmitResult(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveSubmitResultJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveSubmitResultProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *masterServer) serveSubmitResultJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "SubmitResult")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	handler := s.Master.SubmitResult
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *IntegralResult) (*Acknowledgment, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*IntegralResult)
					if !ok {
					...
					return s.Master.SubmitResult(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*Acknowledgment)
...
func (s *masterServer) serveSubmitResultProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "SubmitResult")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *masterServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *masterServer) ProtocGenTwirpVersion() string {
	return "v8.1.3"
}
...
func (s *masterServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "github.com.JuanJoseLL.integrales", "Master")
}
